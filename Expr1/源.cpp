	...
	if (type == 2) {
		...
		while (true) {
			...
			if (len == -2) {
				...
				printf(" ... 正在传输Block %d\t... 传输进度 [%.2f %%] (%.2lf MB / %.2lf MB).................. \r", blocknum, 100.0 * current_size / total_size, 1.0 * current_size / 1024.0 / 1024.0, total_size * 1.0 / 1024 / 1024);
			}
		}
		fclose(readfp);
	}
